...
from FlashXMusic.utils.decorators.admins import ActualAdminCB
from FlashXMusic.utils.decorators.language import language, languageCB
from FlashXMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from FlashXMusic.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://te.legra.ph/file/fc75fef760c29e8ccdf8b.mp4"),
